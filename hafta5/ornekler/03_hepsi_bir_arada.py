# =============================================================
# DERS 3: Birleşik Örnek — Mini Portfolyo Yöneticisi
# =============================================================
...
#   - Tüm Hafta 5 konularını birleştirme
...
# 75'in altındaki projeleri atla, sadece başarılıları göster.
# continue: döngünün geri kalanını atlar, bir sonraki tura geçer.
print()
